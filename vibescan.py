...
BUILDER_HOST_SUFFIXES = [
    ...
    "figma.site", "framer.app", "framer.website", "webflow.io",
    "wixsite.com", "bubbleapps.io", "softr.app",
]
...
BUILDER_BLOB_PATTERNS = [
    ...
    ("webflow",      re.compile(r"made (with|in) webflow|webflow\.io|"
                                r"powered by webflow", re.I)),
    ("wix",          re.compile(r"made with wix|wix\.com|wixsite\.com|"
                                r"powered by wix", re.I)),
    ("bubble",       re.compile(r"made (with|on|in) bubble|bubble\.io", re.I)),
    ("softr",        re.compile(r"made (with|on|in) softr|softr\.io", re.I)),
]
...
SCORE_HOST_SUFFIX: dict[str, tuple[int, str]] = {
    # AI-native scaffolders (strong attribution from host alone)
    "lovableproject.com": (10, "Lovable"),
    "bolt.host":          (10, "bolt.new"),
    "base44.app":         (10, "Base44"),
    "replit.dev":         (6,  "Replit"),
    "repl.co":            (6,  "Replit"),
    # Visual/no-code builders with AI layers
    "figma.site":         (8,  "Figma"),
    "framer.app":         (8,  "Framer"),
    "framer.website":     (8,  "Framer"),
    "webflow.io":         (8,  "Webflow"),
    "wixsite.com":        (8,  "Wix"),
    "bubbleapps.io":      (8,  "Bubble"),
    "softr.app":          (8,  "Softr"),
    # Generic hosting (weak signal — also used by hand-coded sites)
...
# Any of these in <meta name="generator"> bumps the score for that builder.
# Premise: even "pure no-code" platforms now layer AI codegen on top —
# Framer AI, Wix Studio AI assistants, Webflow AI, Figma Make. Auto-generated
# code is auto-generated code; the risk surface (committed-as-default
# tooling artifacts, exposed configs, AI-shaped prompts) is the same.
META_GENERATOR_KEYWORDS = ["lovable", "v0", "bolt", "base44", "framer",
                          "wix", "webflow", "bubble", "softr", "figma"]
